...
/* put the exponential color code (255*(-1 +exp(code))/(-1 +exp(255)) ) */
...
static void exponential (GimpDrawable     *drawable);
...
query (void)
{
  ...
  gimp_install_procedure (
    "plug-in-exponential",
    "Exponential",
    "get exponential color code of the image",
    "Sebastien",
    "GPL Sebastien",
    "2012",
    "_Exponential",
  ...
  gimp_plugin_menu_register ("plug-in-exponential",
                             "<Image>/Filters/Math");
}
     ...
     GimpParam       **return_vals)
{
  ...
  *return_vals  = values;
  ...
  gimp_progress_init ("Exponential ...");
